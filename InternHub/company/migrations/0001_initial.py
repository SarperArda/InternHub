    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departments', models.CharField(choices=[('CS', 'Computer Engineering'), ('EEE', 'Electrical and Electronics Engineering'), ('IE', 'Industrial Engineering'), ('ME', 'Mechanical Engineering')], max_length=3)),
            ],
        ),
        migrations.CreateModel(
